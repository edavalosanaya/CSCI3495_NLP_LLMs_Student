...
Two helpers:
  ...
  * ReflexiveLLM(...)  , behaves differently once a reflection (lesson) appears
                          in the transcript, so we can test the Reflexion loop:
                          fail on attempt 1, succeed after reflecting.
"""
