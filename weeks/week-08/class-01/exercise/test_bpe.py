...
def test_step4_train_picks_most_frequent_first():
...
def test_step4_train_is_deterministic():
    m1 = bpe.train_bpe(CORPUS, num_merges=8)
    m2 = bpe.train_bpe(CORPUS, num_merges=8)
    assert m1 == m2


def test_step4_train_stops_when_no_pairs():
...
def test_step5_encode_known_word_collapses():
...
def test_step5_encode_unknown_word_still_works():
