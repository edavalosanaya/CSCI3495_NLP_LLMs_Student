# W3C2: Tensors, autograd, and fitting a line

This notebook is the **second half** of the class; the first half is probability
on the whiteboard, no laptops. We work through it together, cell by cell. Each
part ends with a `TRY IT`: one question, one empty cell.
...
Then open `weeks/week-03/class-02/exercise/lab.ipynb` in your editor, select the
