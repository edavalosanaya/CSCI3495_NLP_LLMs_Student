...
and the first data point in the reliability thread that runs to Week 11 (evaluation
...
**Where this goes.** Week 9 covers decoding properly, greedy vs beam vs top-k vs
...
carry out of Week 1. It is the thesis of W11C2 (hallucination) and it is why the
course spends Week 11 on evaluation at all.
