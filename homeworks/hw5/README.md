...
**Out:** Mon Nov 9 · **Due:** Mon Nov 30 · **100 points** · individual work

Everything is in **`hw5.ipynb`**. There are 6 `YOUR TURN` cells,
...
Then open `homeworks/hw5/hw5.ipynb`, select the project's **`.venv`** kernel, and
